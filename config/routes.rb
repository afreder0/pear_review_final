Rails.application.routes.draw do
  ...
  # Routes for the Dishing resource:
  # CREATE
  get "/dishings/new", :controller => "dishings", :action => "new"
  post "/create_dishing", :controller => "dishings", :action => "create"

  # READ
  get "/dishings", :controller => "dishings", :action => "index"
  get "/dishings/:id", :controller => "dishings", :action => "show"

  # UPDATE
  get "/dishings/:id/edit", :controller => "dishings", :action => "edit"
  post "/update_dishing/:id", :controller => "dishings", :action => "update"

  # DELETE
  get "/delete_dishing/:id", :controller => "dishings", :action => "destroy"
  #------------------------------
